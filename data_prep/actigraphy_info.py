...
class GetActigraphyInfo:
    ...
    def get_means(self, df: pd.DataFrame):
        ...
        return [acc_magn_mean, enmo_mean, anglez_mean, light_mean, battery_voltage_mean]
...
if __name__ == '__main__':
    ...
    column_names = ["id", "acc_magn_mean", "enmo_mean", "anglez_mean", "light_mean", "battery_voltage_mean"]
